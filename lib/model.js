...
class Model {
  ...
  */
   ...
   * @param  {object}                                                    [options.systemTime] Query system time for point in time data.
   * @param  {string}                                                    [options.systemTime.type] Type of system time query to use.
   * @param  {Date}                                                      [options.systemTime.startDate] Start date for system time query.
   * @param  {Date}                                                      [options.systemTime.endDate] End date for system time query.
   *
   * @see
